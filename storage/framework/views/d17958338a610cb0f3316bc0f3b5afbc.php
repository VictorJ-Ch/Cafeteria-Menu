            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#">
                        <img src="<?php echo e(asset('img/Icon/Icon.webp')); ?>" class="img-fluid img-sm" alt="Famtime-food-app-logo">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                <img src="<?php echo e(asset('img/Icon/Famtime_food_Logo.webp')); ?>" class=" img-fluid img-sm" alt="QR-code">
                            </li>
                        </ul>
                    </div>
                            ...
                            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                                <?php if(auth()->guard()->check()): ?>
                                    <button type="button" class="btn btn-outline-secondary">
                                        <a href="<?php echo e(url('/home')); ?>" class="font-semibold text-black hover:text-gray-900 dark:text-gray-400 dark:hover:text-grey focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Home</a>
                                    </button>
                                <?php else: ?>
                                    <button type="button" class="btn btn-outline-secondary">
                                        <a href="<?php echo e(route('login')); ?>" class="font-semibold text-black hover:text-gray-900 dark:text-gray-400 dark:hover:text-grey focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log in</a>
                                    </button>
                                    <?php if(Route::has('register')): ?>
                                        <button type="button" class="btn btn-outline-secondary">
                                                <a href="<?php echo e(route('register')); ?>" class="ml-4 font-semibold text-black hover:text-gray-900 dark:text-gray-400 dark:hover:text-grey focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Register</a>
                                        </button>                     
                                    <?php endif; ?>
                                <?php endif; ?>
                                </div>
                    ...
                    <div class="container text-center">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                ...
                                <!--DO process-->
                                <img src="<?php echo e(asset('img/eclipse-logo.png')); ?>" class="img-thumbnail img-fluid img-pretty" alt="QR-code"> 
                            </div>
                        <div class="col-lg-4 col-md-4 col-sm-12">
...
<?php /**PATH C:\xampp\htdocs\Cafeteria-Menu\resources\views/welcome.blade.php ENDPATH**/ ?>